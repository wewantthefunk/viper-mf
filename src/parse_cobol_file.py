...
if __name__ == "__main__":
    ...
    parse_cobol_file("work/RRBTOSSA.cbl", "converted/")
    #parse_cobol_file("dependencies/GETDSNS.cbl", "converted/")
    #parse_cobol_file("dependencies/CEE3AB2.cbl", "converted/")
    #parse_cobol_file("examples/hellow80_address_passed_to_call.cbl", "converted/")
    ...
    #parse_cobol_file("examples/hellow82_sort.cbl", "converted/")
    #parse_cobol_file("examples/hellow83_sort_2.cbl", "converted/")