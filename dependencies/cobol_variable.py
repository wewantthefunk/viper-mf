...
def initialize():
    ...
    EBCDIC_ASCII_CHART.append(EBCDICASCII('04', '\x5E', '\x04'))
    ...
    EBCDIC_ASCII_CHART.append(EBCDICASCII('14', '\x5D', '\x14'))
    EBCDIC_ASCII_CHART.append(EBCDICASCII('15', '\x08', '\x15'))
    EBCDIC_ASCII_CHART.append(EBCDICASCII('16', '\xA5', '\x16'))
    ...
    EBCDIC_ASCII_CHART.append(EBCDICASCII('1C', '\xC1', '\x1C'))
    EBCDIC_ASCII_CHART.append(EBCDICASCII('1D', '\x1D', '\x1D'))
    EBCDIC_ASCII_CHART.append(EBCDICASCII('1E', '\xC2', '\x1E'))
    ...
    EBCDIC_ASCII_CHART.append(EBCDICASCII('22', '\x1C', '"'))
    ...
    EBCDIC_ASCII_CHART.append(EBCDICASCII('2D', '\xD2', '\x2D'))
    ...
    EBCDIC_ASCII_CHART.append(EBCDICASCII('6A', '\xA6'   , 'j'))
    ...
    EBCDIC_ASCII_CHART.append(EBCDICASCII('78', '\x05', 'x'))
    ...
    EBCDIC_ASCII_CHART.append(EBCDICASCII('AC', '\x5B', '\xAC'))
